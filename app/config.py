...
class Settings(BaseSettings):
    ...
    # === API Keys ===
    NCBI_API_KEY: str | None = None  # For higher E-utilities rate limits
    NCBI_EMAIL: str = "verifai@example.com"  # Required for Entrez
    SEMANTIC_SCHOLAR_API_KEY: str | None = None
    HUGGINGFACE_TOKEN: str | None = None  # For gated models
